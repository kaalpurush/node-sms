...
var Airtel=function(api_key,api_secret){
	...
	this.send=function (from, to, message, callback){
		request.post({			
			url:		this.end_point+'?REQUESTTYPE=SMSSubmitReq&USERNAME='+this.api_key+'&PASSWORD='+this.api_secret+'&TYPE=0&ORIGIN_ADDR='+from+'&MOBILENO='+to+'&MESSAGE='+encodeURIComponent(message)
